...
class LiteRASPP(nn.Module):
    """Lite R-ASPP Module"""
    def __init__(self, in_channels, out_channels=256, num_classes=2):
...
class ModifiedDeepLabV3(nn.Module):
    ...
    def forward(self, x):
        ...
        x = F.interpolate(x, size=(512, 512), mode='bilinear', align_corners=False)  # Adjust to your target size
        result = {'out': x}
        return result
